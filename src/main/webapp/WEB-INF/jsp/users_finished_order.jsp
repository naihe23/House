		...
		<div id="right" frameborder="0" seamless>
			<div id="right-header">
				<input type="text" class="form-control" placeholder="请输入户主姓名"
					style="float: left" id="house_owner_name" /> <input type="button"
					name="house_owner_name" class="btn btn-primary" value="搜索"
					style="margin-left: 5px" onclick="searchByName()" />
			</div>
			<form role="form">
				<div id="content">
					<table class="table table-hover " id="house_message_table">
						...
						<tr>
							<td colspan="11"><ul class="pagination ">
...
function setContent(contents){//将json数据解析并输出到页面上
    ...
    var p=document.getElementById("content_body").parentNode;//先将之前的删除
    p.removeChild(document.getElementById("content_body"));
    var c=document.createElement("tbody");
    c.setAttribute("id","content_body");
    p.appendChild(c);
